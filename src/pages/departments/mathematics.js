  ...
  return (
    <div className="min-h-screen bg-gray-50 py-16 px-6 md:px-20">
      <header className="max-w-4xl mx-auto text-center mb-12">
        <h1 className="text-5xl font-bold text-gray-900 mb-4">Mathematics Department</h1>
        <p className="text-lg text-gray-700">
          Our Mathematics Department is dedicated to developing analytical and problem-solving skills through comprehensive courses ranging from Algebra to Calculus and Statistics.
        </p>
      </header>
      ...
      <section className="max-w-5xl mx-auto bg-white p-8 rounded-lg shadow-md">
        ...
        <p className="text-gray-700 mb-6">
          We provide access to modern math software, interactive tools, and a well-stocked math resource library to support learning and research.
        </p>

        <h2 className="text-3xl font-semibold text-orange-600 mb-6">Extra-Curricular Activities</h2>
        <ul className="list-disc list-inside text-gray-700 mb-8 space-y-2">
          <li>Math club competitions and puzzles</li>
          <li>Participation in national and regional math olympiads</li>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-gray-100 rounded-lg p-4 text-center shadow">
            <img
              src="/images/teachers/ms-chirwa.jpg"
              alt="Ms. Chirwa"
              className="mx-auto mb-4 w-24 h-24 rounded-full object-cover"
            />
            <h3 className="font-bold text-lg text-gray-900">Ms. Chirwa</h3>
            <p className="text-gray-700">Algebra & Geometry</p>
          </div>

          <div className="bg-gray-100 rounded-lg p-4 text-center shadow">
            <img
              src="/images/teachers/mr-kasungu.jpg"
              alt="Mr. Kasungu"
              className="mx-auto mb-4 w-24 h-24 rounded-full object-cover"
            />
            <h3 className="font-bold text-lg text-gray-900">Mr. Kasungu</h3>
            <p className="text-gray-700">Calculus & Statistics</p>
          </div>

          <div className="bg-gray-100 rounded-lg p-4 text-center shadow">
            <img
              src="/images/teachers/ms-mbale.jpg"
              alt="Ms. Mbale"
              className="mx-auto mb-4 w-24 h-24 rounded-full object-cover"
            />
            <h3 className="font-bold text-lg text-gray-900">Ms. Mbale</h3>
            <p className="text-gray-700">Applied Mathematics</p>
          </div>
        </div>
      </section>
    </div>
