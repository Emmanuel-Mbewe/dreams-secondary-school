    ...
    return (
      ...
      >
        ...
        >
          ...
          <button
            type="submit"
            className="w-full bg-blue-700 text-white p-4 rounded-lg text-lg font-semibold hover:bg-blue-800 transition"
          >
            Login
          </button>
        </form>
    ...
    return (
      <nav className="flex flex-col bg-white shadow-lg rounded-lg p-4 w-64 h-[calc(100vh-5rem)] sticky top-[5rem]">
        ...
        <button
          ...
          className="mt-auto bg-red-600 text-white px-4 py-3 rounded-lg hover:bg-red-700 transition font-semibold text-lg"
        >
          Logout
        </button>
      </nav>
